...
# for loops are often preferred for iterating over collections, while while loops are used when you need more flexibility in controlling the loop's termination based on a condition.
...
# print statement written before the conditional statemnt prints all the values of item in the range while prints statement insdide the condition only executes when the statemnt is true.
