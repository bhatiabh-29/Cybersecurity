...
# data type of the employee id when its first displayed is integer. later when its converted to string the data type changes to string ./
# 
...
# the code outputs the domain extension .com since the index where .com starts in the url is 19 in the string. and slicing the index by 19:19+4 which is 22 gives us .com.
# 
# 
# 
...
# 
#     
# learning the slicing and indexing for using string is very important which might be ver helpful in cycbersecurity tasks.
# 
# 
# 
# 
