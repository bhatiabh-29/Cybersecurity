...
# When approved_users[0] is displayed the first element in the approved users list is printed. if it is replaced by any other index, username on that index in the list will be printed.
...
# new user and new device id is added to the end of approved users and approved devices lists
...
# removed username and device id is removed from both the lists
...
# After running the code cell the index number of user is printed
...
# Device Id of the username sgilmore is printed 
...
# The username sgilmore is approved to access the system and 4n482ts is the assigned device for sgilmore
...
# if the device id is correct it displays 8rp2k75 is the assigned device for elarson and if the device id is not correct it displays hl0s5o1 is not their assigned device.
