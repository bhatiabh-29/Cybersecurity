...
# the contents of the file as returned as list after using the split file
...
# after using the write function the missing entries are displayed at the end of the file 
