...
# the import file variable is used withou reading the file content , it displays it as a string
...
# yes all the four ip addresses in the removed list are part of the allow txt file/
# 
...
# writing an algorithm in a single function makes the code more reuasble and readable 
